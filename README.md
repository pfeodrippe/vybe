...
- OSX universal
  - `io.github.pfeodrippe/vybe {:mvn/version "0.6.338-macos-universal"}`
- Linux (x64)
  - `io.github.pfeodrippe/vybe {:mvn/version "0.6.338-linux-x64"}`
- Windows (x64)
  - `io.github.pfeodrippe/vybe {:mvn/version "0.6.338-win-x64"}`
