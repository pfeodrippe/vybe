...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        netcode.C_POINTER.withName("__routine"),
        netcode.C_POINTER.withName("__arg"),
        netcode.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = netcode.upcallHandle(__routine.Function.class, "apply", $DESC);
