 ...
 * }
 */
public class netcode_assert_function {
    ...
    private static final MethodHandle UP$MH = netcode.upcallHandle(netcode_assert_function.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(netcode_assert_function.Function fi, Arena arena) {
