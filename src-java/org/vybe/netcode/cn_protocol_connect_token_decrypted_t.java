...
/**
 * {@snippet lang=c :
 * struct cn_protocol_connect_token_decrypted_t {
 ...
 * }
 */
public class cn_protocol_connect_token_decrypted_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(256, netcode.C_CHAR).withName("user_data"),
        cn_crypto_signature_t.layout().withName("signature")
    ).withName("cn_protocol_connect_token_decrypted_t");
    ...
    private static final long expiration_timestamp$OFFSET = 0;
    ...
    private static final long handshake_timeout$OFFSET = 8;
    ...
    private static final long endpoint_count$OFFSET = 12;
    ...
    private static final long endpoints$OFFSET = 16;
    ...
    private static final long client_id$OFFSET = 784;
    ...
    private static final long client_to_server_key$OFFSET = 792;
    ...
    private static final long server_to_client_key$OFFSET = 824;
    ...
    private static final long user_data$OFFSET = 856;
    ...
    private static long[] user_data$DIMS = { 256 };
     ...
     * }
     */
    public static byte user_data(MemorySegment struct, long index0) {
        return (byte)user_data$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void user_data(MemorySegment struct, long index0, byte fieldValue) {
        user_data$ELEM_HANDLE.set(struct, 0L, index0, fieldValue);
    }
    ...
    private static final long signature$OFFSET = 1112;
