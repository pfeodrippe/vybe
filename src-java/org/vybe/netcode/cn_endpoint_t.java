...
public class cn_endpoint_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cn_endpoint_t.u.layout().withName("u"),
        MemoryLayout.paddingLayout(2)
    ).withName("cn_endpoint_t");
    ...
    private static final long port$OFFSET = 4;
    ...
    private static final long u$OFFSET = 6;
