...
/**
 * {@snippet lang=c :
 * struct cn_protocol_connect_token_cache_entry_t {
 *     cn_list_node_t *node;
 * }
 * }
 */
public class cn_protocol_connect_token_cache_entry_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        netcode.C_POINTER.withName("node")
    ).withName("cn_protocol_connect_token_cache_entry_t");
