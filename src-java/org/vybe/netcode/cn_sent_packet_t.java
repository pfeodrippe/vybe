...
public class cn_sent_packet_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        netcode.C_INT.withName("acked"),
        netcode.C_INT.withName("size")
    ).withName("cn_sent_packet_t");
    ...
    private static final OfInt acked$LAYOUT = (OfInt)$LAYOUT.select(groupElement("acked"));
     ...
     * }
     */
    public static final OfInt acked$layout() {
        return acked$LAYOUT;
    }

    private static final long acked$OFFSET = 8;
     ...
     * }
     */
    public static final long acked$offset() {
        return acked$OFFSET;
    }
     ...
     * }
     */
    public static int acked(MemorySegment struct) {
        return struct.get(acked$LAYOUT, acked$OFFSET);
    }
     ...
     * }
     */
    public static void acked(MemorySegment struct, int fieldValue) {
        struct.set(acked$LAYOUT, acked$OFFSET, fieldValue);
    }
