...
/**
 * {@snippet lang=c :
 * struct cn_protocol_server_event_t {
 ...
 * }
 */
public class cn_protocol_server_event_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cn_protocol_server_event_t.u.layout().withName("u")
    ).withName("cn_protocol_server_event_t");
    ...
    public static class u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            cn_protocol_server_event_t.u.new_connection.layout().withName("new_connection"),
            cn_protocol_server_event_t.u.disconnected.layout().withName("disconnected"),
            cn_protocol_server_event_t.u.payload_packet.layout().withName("payload_packet")
        ).withName("$anon$4190:2");
