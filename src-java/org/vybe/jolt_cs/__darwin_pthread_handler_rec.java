...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        jolt_cs.C_POINTER.withName("__routine"),
        jolt_cs.C_POINTER.withName("__arg"),
        jolt_cs.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = jolt_cs.upcallHandle(__routine.Function.class, "apply", $DESC);
