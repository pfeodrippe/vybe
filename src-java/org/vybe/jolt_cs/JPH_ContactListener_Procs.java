 ...
 *     JPH_ValidateResult (*OnContactValidate)(void *, const JPH_Body *, const JPH_Body *, const JPH_RVec3 *, const JPH_CollideShapeResult *);
 *     void (*OnContactAdded)(void *, const JPH_Body *, const JPH_Body *, const JPH_ContactManifold *, JPH_ContactSettings *);
 *     void (*OnContactPersisted)(void *, const JPH_Body *, const JPH_Body *, const JPH_ContactManifold *, JPH_ContactSettings *);
 *     void (*OnContactRemoved)(void *, const JPH_SubShapeIDPair *);
 * }
 * }
 */
public class JPH_ContactListener_Procs {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        jolt_cs.C_POINTER.withName("OnContactPersisted"),
        jolt_cs.C_POINTER.withName("OnContactRemoved")
    ).withName("JPH_ContactListener_Procs");
    ...
    public static class OnContactPersisted {
        ...
        private static final MethodHandle UP$MH = jolt_cs.upcallHandle(OnContactPersisted.Function.class, "apply", $DESC);
    ...
    public static class OnContactRemoved {
        ...
        private static final MethodHandle UP$MH = jolt_cs.upcallHandle(OnContactRemoved.Function.class, "apply", $DESC);
