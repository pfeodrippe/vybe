...
public class rusage_info_v6 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, flecs.C_CHAR).withName("ri_uuid"),
        flecs.C_LONG_LONG.withName("ri_user_time"),
        flecs.C_LONG_LONG.withName("ri_system_time"),
        flecs.C_LONG_LONG.withName("ri_pkg_idle_wkups"),
        flecs.C_LONG_LONG.withName("ri_interrupt_wkups"),
        flecs.C_LONG_LONG.withName("ri_pageins"),
        flecs.C_LONG_LONG.withName("ri_wired_size"),
        flecs.C_LONG_LONG.withName("ri_resident_size"),
        flecs.C_LONG_LONG.withName("ri_phys_footprint"),
        flecs.C_LONG_LONG.withName("ri_proc_start_abstime"),
        flecs.C_LONG_LONG.withName("ri_proc_exit_abstime"),
        flecs.C_LONG_LONG.withName("ri_child_user_time"),
        flecs.C_LONG_LONG.withName("ri_child_system_time"),
        flecs.C_LONG_LONG.withName("ri_child_pkg_idle_wkups"),
        flecs.C_LONG_LONG.withName("ri_child_interrupt_wkups"),
        flecs.C_LONG_LONG.withName("ri_child_pageins"),
        flecs.C_LONG_LONG.withName("ri_child_elapsed_abstime"),
        flecs.C_LONG_LONG.withName("ri_diskio_bytesread"),
        flecs.C_LONG_LONG.withName("ri_diskio_byteswritten"),
        flecs.C_LONG_LONG.withName("ri_cpu_time_qos_default"),
        flecs.C_LONG_LONG.withName("ri_cpu_time_qos_maintenance"),
        flecs.C_LONG_LONG.withName("ri_cpu_time_qos_background"),
        flecs.C_LONG_LONG.withName("ri_cpu_time_qos_utility"),
        flecs.C_LONG_LONG.withName("ri_cpu_time_qos_legacy"),
        flecs.C_LONG_LONG.withName("ri_cpu_time_qos_user_initiated"),
        flecs.C_LONG_LONG.withName("ri_cpu_time_qos_user_interactive"),
        flecs.C_LONG_LONG.withName("ri_billed_system_time"),
        flecs.C_LONG_LONG.withName("ri_serviced_system_time"),
        flecs.C_LONG_LONG.withName("ri_logical_writes"),
        flecs.C_LONG_LONG.withName("ri_lifetime_max_phys_footprint"),
        flecs.C_LONG_LONG.withName("ri_instructions"),
        flecs.C_LONG_LONG.withName("ri_cycles"),
        flecs.C_LONG_LONG.withName("ri_billed_energy"),
        flecs.C_LONG_LONG.withName("ri_serviced_energy"),
        flecs.C_LONG_LONG.withName("ri_interval_max_phys_footprint"),
        flecs.C_LONG_LONG.withName("ri_runnable_time"),
        flecs.C_LONG_LONG.withName("ri_flags"),
        flecs.C_LONG_LONG.withName("ri_user_ptime"),
        flecs.C_LONG_LONG.withName("ri_system_ptime"),
        flecs.C_LONG_LONG.withName("ri_pinstructions"),
        flecs.C_LONG_LONG.withName("ri_pcycles"),
        flecs.C_LONG_LONG.withName("ri_energy_nj"),
        flecs.C_LONG_LONG.withName("ri_penergy_nj"),
        flecs.C_LONG_LONG.withName("ri_secure_time_in_system"),
        flecs.C_LONG_LONG.withName("ri_secure_ptime_in_system"),
        flecs.C_LONG_LONG.withName("ri_neural_footprint"),
        flecs.C_LONG_LONG.withName("ri_lifetime_max_neural_footprint"),
        flecs.C_LONG_LONG.withName("ri_interval_max_neural_footprint"),
        MemoryLayout.sequenceLayout(9, flecs.C_LONG_LONG).withName("ri_reserved")
