...
public class __darwin_ucontext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        flecs.C_INT.withName("uc_onstack"),
        flecs.C_INT.withName("uc_sigmask"),
        __darwin_sigaltstack.layout().withName("uc_stack"),
        flecs.C_POINTER.withName("uc_link"),
        flecs.C_LONG.withName("uc_mcsize"),
        flecs.C_POINTER.withName("uc_mcontext")
