...
public class __darwin_arm_thread_state64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(29, flecs.C_LONG_LONG).withName("__x"),
        flecs.C_LONG_LONG.withName("__fp"),
        flecs.C_LONG_LONG.withName("__lr"),
        flecs.C_LONG_LONG.withName("__sp"),
        flecs.C_LONG_LONG.withName("__pc"),
        flecs.C_INT.withName("__cpsr"),
        flecs.C_INT.withName("__pad")
