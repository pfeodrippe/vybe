...
public class __siginfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        flecs.C_INT.withName("si_signo"),
        flecs.C_INT.withName("si_errno"),
        flecs.C_INT.withName("si_code"),
        flecs.C_INT.withName("si_pid"),
        flecs.C_INT.withName("si_uid"),
        flecs.C_INT.withName("si_status"),
        flecs.C_POINTER.withName("si_addr"),
        sigval.layout().withName("si_value"),
        flecs.C_LONG.withName("si_band"),
        MemoryLayout.sequenceLayout(7, flecs.C_LONG).withName("__pad")
    ).withName("__siginfo");
