...
public class sigevent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        flecs.C_INT.withName("sigev_notify"),
        flecs.C_INT.withName("sigev_signo"),
        sigval.layout().withName("sigev_value"),
        flecs.C_POINTER.withName("sigev_notify_function"),
        flecs.C_POINTER.withName("sigev_notify_attributes")
    ).withName("sigevent");
    ...
    public static class sigev_notify_function {
        ...
        private static final MethodHandle UP$MH = flecs.upcallHandle(sigev_notify_function.Function.class, "apply", $DESC);
