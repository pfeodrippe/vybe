...
public class __sigaction {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        flecs.C_POINTER.withName("sa_tramp"),
        flecs.C_INT.withName("sa_mask"),
        flecs.C_INT.withName("sa_flags")
    ...
    public static class sa_tramp {
        ...
        private static final MethodHandle UP$MH = flecs.upcallHandle(sa_tramp.Function.class, "apply", $DESC);
