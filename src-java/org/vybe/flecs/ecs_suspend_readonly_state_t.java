...
public class ecs_suspend_readonly_state_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        flecs.C_BOOL.withName("cmd_flushing"),
        MemoryLayout.paddingLayout(1),
        flecs.C_INT.withName("defer_count"),
        flecs.C_LONG_LONG.withName("scope"),
        flecs.C_LONG_LONG.withName("with"),
        MemoryLayout.sequenceLayout(2, ecs_commands_t.layout()).withName("cmd_stack"),
        flecs.C_POINTER.withName("cmd"),
    ...
    private static final OfBoolean cmd_flushing$LAYOUT = (OfBoolean)$LAYOUT.select(groupElement("cmd_flushing"));
     ...
     * }
     */
    public static final OfBoolean cmd_flushing$layout() {
        return cmd_flushing$LAYOUT;
    }

    private static final long cmd_flushing$OFFSET = 2;
     ...
     * }
     */
    public static final long cmd_flushing$offset() {
        return cmd_flushing$OFFSET;
    }
     ...
     * }
     */
    public static boolean cmd_flushing(MemorySegment struct) {
        return struct.get(cmd_flushing$LAYOUT, cmd_flushing$OFFSET);
    }
     ...
     * }
     */
    public static void cmd_flushing(MemorySegment struct, boolean fieldValue) {
        struct.set(cmd_flushing$LAYOUT, cmd_flushing$OFFSET, fieldValue);
    }
    ...
    private static final SequenceLayout cmd_stack$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("cmd_stack"));
     ...
     * }
     */
    public static final SequenceLayout cmd_stack$layout() {
        return cmd_stack$LAYOUT;
    }

    private static final long cmd_stack$OFFSET = 24;
     ...
     * }
     */
    public static final long cmd_stack$offset() {
        return cmd_stack$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment cmd_stack(MemorySegment struct) {
        return struct.asSlice(cmd_stack$OFFSET, cmd_stack$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void cmd_stack(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, cmd_stack$OFFSET, cmd_stack$LAYOUT.byteSize());
    }

    private static long[] cmd_stack$DIMS = { 2 };
     ...
     * }
     */
    public static long[] cmd_stack$dimensions() {
        return cmd_stack$DIMS;
    }
    private static final MethodHandle cmd_stack$ELEM_HANDLE = cmd_stack$LAYOUT.sliceHandle(sequenceElement());
     ...
     * }
     */
    public static void cmd_stack(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, cmd_stack(struct, index0), 0L, ecs_commands_t.layout().byteSize());
    }

    private static final AddressLayout cmd$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("cmd"));
     ...
     * }
     */
    public static final AddressLayout cmd$layout() {
        return cmd$LAYOUT;
    }

    private static final long cmd$OFFSET = 232;
    ...
    private static final long stage$OFFSET = 240;
