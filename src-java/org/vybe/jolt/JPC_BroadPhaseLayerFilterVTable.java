...
/**
 * {@snippet lang=c :
 * struct JPC_BroadPhaseLayerFilterVTable {
 *     const void *__vtable_header[2];
 *     bool (*ShouldCollide)(const void *, JPC_BroadPhaseLayer);
 * }
 * }
 */
public class JPC_BroadPhaseLayerFilterVTable {
    ...
    public static class ShouldCollide {
        ...
        public interface Function {
            boolean apply(MemorySegment _x0, byte _x1);
        }
         ...
         */
        public static boolean invoke(MemorySegment funcPtr,MemorySegment _x0, byte _x1) {
            try {
