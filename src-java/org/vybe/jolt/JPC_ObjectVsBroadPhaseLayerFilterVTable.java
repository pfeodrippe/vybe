...
/**
 * {@snippet lang=c :
 * struct JPC_ObjectVsBroadPhaseLayerFilterVTable {
 *     const void *__vtable_header[2];
 *     bool (*ShouldCollide)(const void *, JPC_ObjectLayer, JPC_BroadPhaseLayer);
 * }
 * }
 */
public class JPC_ObjectVsBroadPhaseLayerFilterVTable {
    ...
    ).withName("JPC_ObjectVsBroadPhaseLayerFilterVTable");
    ...
    public static class ShouldCollide {
        ...
        public interface Function {
            boolean apply(MemorySegment _x0, short _x1, byte _x2);
        }
         ...
         */
        public static boolean invoke(MemorySegment funcPtr,MemorySegment _x0, short _x1, byte _x2) {
            try {
