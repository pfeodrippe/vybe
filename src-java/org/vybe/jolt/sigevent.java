...
public class sigevent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        jolt.C_INT.withName("sigev_notify"),
        jolt.C_INT.withName("sigev_signo"),
        sigval.layout().withName("sigev_value"),
        jolt.C_POINTER.withName("sigev_notify_function"),
        jolt.C_POINTER.withName("sigev_notify_attributes")
    ).withName("sigevent");
    ...
    public static class sigev_notify_function {
        ...
        private static final MethodHandle UP$MH = jolt.upcallHandle(sigev_notify_function.Function.class, "apply", $DESC);
