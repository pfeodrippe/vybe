...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        jolt.C_POINTER.withName("__routine"),
        jolt.C_POINTER.withName("__arg"),
        jolt.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = jolt.upcallHandle(__routine.Function.class, "apply", $DESC);
