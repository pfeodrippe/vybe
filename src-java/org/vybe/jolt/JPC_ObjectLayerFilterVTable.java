...
/**
 * {@snippet lang=c :
 * struct JPC_ObjectLayerFilterVTable {
 *     const void *__vtable_header[2];
 *     bool (*ShouldCollide)(const void *, JPC_ObjectLayer);
 * }
 * }
 */
public class JPC_ObjectLayerFilterVTable {
    ...
    public static class ShouldCollide {
        ...
        public interface Function {
            boolean apply(MemorySegment _x0, short _x1);
        }
         ...
         */
        public static boolean invoke(MemorySegment funcPtr,MemorySegment _x0, short _x1) {
            try {
