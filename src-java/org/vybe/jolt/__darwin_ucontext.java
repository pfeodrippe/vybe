...
public class __darwin_ucontext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        jolt.C_INT.withName("uc_onstack"),
        jolt.C_INT.withName("uc_sigmask"),
        __darwin_sigaltstack.layout().withName("uc_stack"),
        jolt.C_POINTER.withName("uc_link"),
        jolt.C_LONG.withName("uc_mcsize"),
        jolt.C_POINTER.withName("uc_mcontext")
