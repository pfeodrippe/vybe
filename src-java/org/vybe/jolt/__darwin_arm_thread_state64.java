...
public class __darwin_arm_thread_state64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(29, jolt.C_LONG_LONG).withName("__x"),
        jolt.C_LONG_LONG.withName("__fp"),
        jolt.C_LONG_LONG.withName("__lr"),
        jolt.C_LONG_LONG.withName("__sp"),
        jolt.C_LONG_LONG.withName("__pc"),
        jolt.C_INT.withName("__cpsr"),
        jolt.C_INT.withName("__pad")
