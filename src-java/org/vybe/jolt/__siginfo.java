...
public class __siginfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        jolt.C_INT.withName("si_signo"),
        jolt.C_INT.withName("si_errno"),
        jolt.C_INT.withName("si_code"),
        jolt.C_INT.withName("si_pid"),
        jolt.C_INT.withName("si_uid"),
        jolt.C_INT.withName("si_status"),
        jolt.C_POINTER.withName("si_addr"),
        sigval.layout().withName("si_value"),
        jolt.C_LONG.withName("si_band"),
        MemoryLayout.sequenceLayout(7, jolt.C_LONG).withName("__pad")
    ).withName("__siginfo");
